...
//    public static final String CHINESE_ANY_STR = "[\u4E00-\u9FFF！|，。（）《》“”？：；【】]";
     ...
     * 只包含中文
     */
    public static final String CHINESE_ONLY_STR = ("[\u4E00-\u9FFF·！￥…（）—【】、|：；‘”“，《。》？]+");

    /**
     * 只包含中文
     */
    public static final Pattern CHINESE_ONLY = Pattern.compile(CHINESE_ONLY_STR);
