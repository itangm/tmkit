...
//    }
    ...
    public static class Builder {
        ...
        public Builder contentType(@NotNull ContentType contentType) {
            this.contentType = Asserts.notNull(contentType, "contentType == null");
            return this;
        }
        ...
        public Builder add(String name, String value, ContentType contentType) {
            if (Strings.hasLength(name)) {
                parts.add(FormPart.create(name, value, contentType));
            }
            return this;
        }
        ...
        public Builder add(String name, File file) {
            if (Strings.hasLength(name) && file != null) {
                parts.add(FormPart.create(name, file));
            }
            return this;
        }

        public Builder add(@NotNull FormPart part) {
            parts.add(Asserts.notNull(part, "part == null"));
            return this;
        }
